...
public class PrimitiveOneLineRow extends Composite implements HasText, ChooseFromConceptHeirarchy, SetLineContentInterface {
	...
	private static PrimitiveOneLineRowUiBinder uiBinder = GWT.create(PrimitiveOneLineRowUiBinder.class);

	interface PrimitiveOneLineRowUiBinder extends UiBinder<Widget, PrimitiveOneLineRow> {
	}

	
	public PrimitiveOneLineRow() {
	...
	public PrimitiveOneLineRow(PrimitiveDataStructureInformation info) {
		initWidget(uiBinder.createAndBindUi(this));
		init();
		fill(info);
	}
