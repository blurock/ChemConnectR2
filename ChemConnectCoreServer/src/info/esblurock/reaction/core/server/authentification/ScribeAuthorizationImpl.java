...
public class ScribeAuthorizationImpl extends ServerBase {
    private static final String PROTECTED_RESOURCE_URL = "https://www.googleapis.com/plus/v1/people/me";

	public void googleAuthorization() {
        final String clientId = getServletContext().getInitParameter("clientID");
        final String clientSecret = getServletContext().getInitParameter("clientSecret");
