package info.esblurock.reaction.chemconnect.core.data.metadata;
...
public class MetaDataKeywords {
	...
	public static String accessLogin = "Login";
	public static String accessQuery = "Query";
	public static String accessProfile = "Profile";
	public static String accessPassword = "Password";
	public static String accessUserDataInput = "UserDataInput";
	public static String accessUserDataDelete = "UserDataDelete";
	...
	public static String setOfObservationsSpecification = "dataset:SetOfObservationsSpecification";
	public static String parameterDescriptionSet = "dataset:ParameterDescriptionSet";
	public static String organizationClassifications = "dataset:OrganizationClassifications";
	public static String organizationClassificationChoices = "dataset:OrganizationClassificationChoices";
	public static String organization = "dataset:Organization";
	public static String databasePerson = "dataset:DatabasePerson";
