...
public class RegistrerDataset {
		public static void register() {
			...
			ObjectifyService.register(ObservationCorrespondenceSpecification.class);
			...
			ObjectifyService.register(SingleObservationDataset.class);
		}
		...
		public static void reset() {
			...
			ResetDatabaseObjects.resetClass(ObservationCorrespondenceSpecification.class);
			...
			ResetDatabaseObjects.resetClass(SingleObservationDataset.class);
		}	
}
